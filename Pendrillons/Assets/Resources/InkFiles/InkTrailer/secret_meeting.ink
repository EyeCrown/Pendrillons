...
- #wait:10
- ARLE: Le jour commence à poindre, messire. Acceptez-vous de ramener le cœur de <shake a=0.5><b>l'abjecte créature</b></shake> ? #anim:Arle:question #playsound:VOX_Arle_lejourcommence 
//- #map:down 
//- #map:departure 
//- #wait:10
//- #map:arrival 
...
//- #audience:applause #wait:100
  //  * [Attendre encore.]
//- #audience:debate #playsound:Play_MUS_Story_SC_SecretMeeting_Encore
//    * [Attendre plus fort.]
//- #audience:booing
- SOUFFLEUR: Le public s'impatiente ! Si ta partenaire de scène ne daigne pas se montrer... Tu vas devoir <b>meubler</b>. #wait:100
